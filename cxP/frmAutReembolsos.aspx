<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Finagil.Master" CodeBehind="frmAutReembolsos.aspx.vb" Inherits="cxP.frmAutReembolsos" %>
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
            ...
            <EditRowStyle BackColor="#F58220" />
                            ...
                            <asp:ObjectDataSource ID="odsAutConComprobante" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="MisAutorizaciones_GetDataBy" TypeName="cxP.dsProduccionTableAdapters.Vw_CXP_AutSinComprobanteTableAdapter">
                                <SelectParameters>
                                    <asp:SessionParameter Name="idEmpresa" SessionField="Empresa" Type="Decimal" />
                                    <asp:SessionParameter Name="idConcepto" SessionField="idConceptoR" Type="Decimal" />
