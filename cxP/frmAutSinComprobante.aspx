<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Finagil.Master" CodeBehind="frmAutSinComprobante.aspx.vb" Inherits="cxP.frmAutSinComprobante" %>
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
            ...
            <EditRowStyle BackColor="#7C6F57" />
                            ...
                            <asp:ObjectDataSource ID="odsAutConComprobante" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="MisAutorizacionesB_GetDataBy" TypeName="cxP.dsProduccionTableAdapters.Vw_CXP_AutSinComprobanteTableAdapter">
                                <SelectParameters>
