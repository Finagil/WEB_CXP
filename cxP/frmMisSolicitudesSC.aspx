...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div style="height: 450px" >
                        ...
                        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" CssClass="auto-style13" DataSourceID="odsMisSolicitudesSC" Height="16px" Width="1331px" ForeColor="#333333" HorizontalAlign="Center" PageSize="20" Font-Names="Arial" AllowCustomPaging="True">
                            <Columns>
