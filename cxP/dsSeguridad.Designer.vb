...
Partial Public Class dsSeguridad
    ...
    Partial Public Class USUARIODataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddUSUARIORow(ByVal nombre As String, ByVal correo As String, ByVal rfc As String) As USUARIORow
            Dim rowUSUARIORow As USUARIORow = CType(Me.NewRow,USUARIORow)
            Dim columnValuesArray() As Object = New Object() {nombre, correo, rfc}
...
Namespace dsSeguridadTableAdapters
    ...
    Partial Public Class USUARIOTableAdapter
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings("csSeguridadNva").ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        USUARIO_1.nombre + ' ' + USUARIO_1.ape_pat + ' ' + USUARIO_1.ape_ma"& _ 
                "t AS nombre, USUARIO_1.correo, USUARIO.rfc"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            USUARIO INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)& _ 
                "                         USUARIO AS USUARIO_1 ON USUARIO.jefe = USUARIO_1.cve_em"& _ 
                "pleado"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (USUARIO.id_usuario = @id_usuario)"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As dsSeguridad.USUARIODataTable, ByVal id_usuario As String) As Integer
        ...
        Public Overloads Overridable Function GetData(ByVal id_usuario As String) As dsSeguridad.USUARIODataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (id_usuario Is Nothing) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
    ...
    Partial Public Class SUCURSALTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [SUCURSAL] WHERE (([id_sucursal] = @Original_id_sucursal))"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [SUCURSAL] SET [id_sucursal] = @id_sucursal, [nom_sucursal] = @nom_sucursa"& _ 
                ...
                "o, [cve_local] = @cve_local WHERE (([id_sucursal] = @Original_id_sucursal))"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_id_sucursal As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal id_sucursal As String, ByVal nom_sucursal As String, ByVal cve_pais As String, ByVal cve_edo As String, ByVal cve_municipio As String, ByVal cve_local As String, ByVal Original_id_sucursal As String) As Integer
            If (id_sucursal Is Nothing) Then
                Throw New Global.System.ArgumentNullException("id_sucursal")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal nom_sucursal As String, ByVal cve_pais As String, ByVal cve_edo As String, ByVal cve_municipio As String, ByVal cve_local As String, ByVal Original_id_sucursal As String) As Integer
            Return Me.Update(Original_id_sucursal, nom_sucursal, cve_pais, cve_edo, cve_municipio, cve_local, Original_id_sucursal)
        End Function
    End Class
