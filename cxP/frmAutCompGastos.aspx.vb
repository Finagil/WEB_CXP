Public Class frmAutCompGastos
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim taEmpresa As New dsProduccionTableAdapters.CXP_EmpresasTableAdapter
        Session.Item("idConceptoG") = taEmpresa.ObtTipoConceptoGts_ScalarQuery(Session.Item("Empresa"))
        ...
        Session.Item("Leyenda") = "Mis Autorizaciones de Comprobación de Gastos"

        Dim taReporte As New dsProduccionTableAdapters.Vw_CXP_AutCompGastosTableAdapter
        Dim dtReporte As New dsProduccion.Vw_CXP_AutCompGastosDataTable
        Dim rowReporte As dsProduccion.Vw_CXP_AutCompGastosRow
