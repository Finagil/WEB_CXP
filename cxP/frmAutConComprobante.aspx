<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Finagil.Master" CodeBehind="frmAutConComprobante.aspx.vb" Inherits="cxP.frmAutConComprobante" %>
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
            ...
            <EditRowStyle BackColor="#F58220" />
                            ...
                            <asp:ObjectDataSource ID="odsAutConComprobante" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="MisAutorizaciones_GetDataBy" TypeName="cxP.dsProduccionTableAdapters.Vw_CXP_AutConComprobanteTableAdapter">
                                <SelectParameters>
