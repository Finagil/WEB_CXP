    ...
    <p>
        <table class="auto-style40">
            ...
            <tr>
                ...
                <td class="auto-style58" style="border-width: 2px; border-color: #FF6600; font-family: Arial; font-size: small; border-top-style: solid; border-bottom-style: solid;">
...
<p class="auto-style30">
        <table style="width: 90%; margin-left:20px; margin-top:10px;" >
            <tr style="width: 100%" >
                ...
                <td id="id8" runat="server" class="auto-style53" style="background-color: #FF6600; font-family: Arial; font-size: small; font-weight: bold; color: #FFFFFF;">Importe Solicitado</td>
                <td id="id9" runat="server" class="auto-style54" style="background-color: #FF6600; font-family: Arial; font-size: small; font-weight: bold; color: #FFFFFF;">Descripción del Pago</td>
                <td id="id10" runat="server" class="auto-style52" style="font-family: Arial; font-weight: bold; color: #FFFFFF; background-color: #FF6600; font-size: small;">Fecha de Pago</td>
                <td id="id11" runat="server" class="auto-style50" style="font-family: Arial; font-weight: bold; color: #FFFFFF; background-color: #FF6600; font-size: small;">Contrato</td>
            </tr>
            <tr>
                ...
                <td id="id14" runat="server" class="auto-style53" style="background-color: #FF6600; font-family: Arial; font-size: small; font-weight: bold;">
                    <asp:TextBox ID="txtMontoSolicitado" runat="server" Width="152px"></asp:TextBox>
                </td>
                <td id="id15" runat="server" class="auto-style54" style="background-color: #FF6600; font-family: Arial; font-size: small; font-weight: bold;">
                    <asp:TextBox ID="txtDescripcionPago" runat="server" Width="535px"></asp:TextBox>
                </td>
                <td id="id16" runat="server" class="auto-style51">
                ...
                <td id="id17" runat="server" class="auto-style50">
                    <asp:CheckBox ID="chkContrato" runat="server" Font-Names="Arial" Font-Size="Small" Text="¿Si?" AutoPostBack="True" />
                </td>
            </tr>
            <tr>
                
                <td id="id18" runat="server" class="auto-style45" colspan="6" style="font-family: Arial; font-size: small; background-color: #FF6600;">
                    Cliente:
                    <asp:DropDownList ID="ddlClientes" runat="server" AutoPostBack="True" DataSourceID="odsClientes" DataTextField="Descr" DataValueField="Cliente" Enabled="False" Width="200px">
                    </asp:DropDownList>
&nbsp;&nbsp;&nbsp; Contrato:
                ...
                &nbsp;&nbsp;&nbsp;
                    Descripción carta neteo:
                    <asp:TextBox ID="txtDesccartaNeteo" runat="server" Width="250px"></asp:TextBox>
                    </td>
                <td class="auto-style55">&nbsp;</td>
            </tr>
            
            <tr>
                <td class="auto-style30" colspan="6" id="contenedor2ID" runat="server">
...
<ItemStyle HorizontalAlign="Left"></ItemStyle>
        ...
        <div class="auto-style30">
            ...
            <br />
                    ...
                    <asp:TextBox ID="txtRevision" runat="server" BackColor="Yellow" Font-Bold="True" Font-Names="Arial" ForeColor="Red" Height="112px" ReadOnly="True" TextMode="MultiLine" Visible="False" Width="721px"></asp:TextBox>
                            </td>
    ...
    <br />
    <asp:Label ID="lblError" runat="server" Font-Names="Arial Black" Font-Size="X-Large" ForeColor="#FF6401" Text="Error" Visible="False"></asp:Label><br /><br /><br />
        </div>
    </p>
<p>
        &nbsp;</p>
